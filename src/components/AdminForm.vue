...
onMounted(async () => {
  ...
  try {
    const response = await fetch(`http://localhost/kajian-admin-api/get-kajian.php?id=${kajianId.value}`)
...
async function handleSimpan() {
  ...
  const url = isEditMode.value
    ? 'http://localhost/kajian-admin-api/update-kajian.php'
    : 'http://localhost/kajian-admin-api/simpan-kajian.php'
